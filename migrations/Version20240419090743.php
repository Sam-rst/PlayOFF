 ...
 */
final class Version20240419090743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tournament (id INT AUTO_INCREMENT NOT NULL, sport_id INT DEFAULT NULL, organisator_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, rules LONGTEXT DEFAULT NULL, is_public TINYINT(1) NOT NULL, start_time DATETIME NOT NULL, end_time DATETIME NOT NULL, gender_rule INT NOT NULL, number_players_per_team INT NOT NULL, type_tournament VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_BD5FB8D9AC78BCF8 (sport_id), INDEX IDX_BD5FB8D9FFDD4EC8 (organisator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, gender INT NOT NULL, username VARCHAR(100) DEFAULT NULL, birth_date DATE DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
